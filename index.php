...
>>>>>>> 33c3c78 (Modify page Photo and Fix size PDPA)
    ...
    <!-- เพิ่ม defer เพื่อให้ Browser แสดงหน้าเว็บ (UI) ได้ทันที ไม่ต้องรอโหลด JS เสร็จ -->
    <script src="js/main.js" defer></script>
    <script src="./face-api.js-master/dist/face-api.min.js" defer></script>
>>>>>>> 1e4782216a4002c59c30390c19d73243f29cfdf0
</head>
...
?>
    ...
    <div class="panel" style="text-align:center; background-color: #f9f9f9; border: 1px  #007bff;">
      <p style="margin-bottom: 8px; font-size: 15px; color: #333;">

      </p>
      <a href="https://forms.gle/bi82vfxouhNankucA" target="_blank" class="btn" style="
...
<<<<<<< HEAD
                ...
                <form id="editUserForm" autocomplete="off">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>เอกสารยินยอมเก็บข้อมูลใบหน้า</td>
                            <td>
                                <a href="./PDF/ConsentBiometric.pdf" target="_blank">คลิกเปิดอ่าน</a>
                            </td>
                        </tr>
                    </table>
                </form>
       ...
       <div class="panel" id="Newtakephoto" style="display:none">
        ...
        <!-- Update not use face -->
        <br>
        <div class="panel" id="updatedata" style="text-align:center;">
            <button type="submit" id="btn-updatedata" name="btn-updatedata" class="btn-updatedata">แก้ไขข้อมูล</button>
        </div>

    <!-- แบบประเมิน -->
        <div class="panel" style="text-align:center;background-color:#f9f9f9;border:1px solid #007bff;">
            <a href="https://forms.gle/bi82vfxouhNankucA" target="_blank" class="btn" style="
        ...
        <div class="panel" style="text-align:center;">
            <form action="logout.php" method="post">
                <button type="submit" class="btn-large-danger">ออกจากระบบ</button>
            </form>
        </div>
    </div>
    ...
    <footer style="margin-top:5px;text-align:center;font-size:13px;color:#777;">
        พัฒนาระบบโดย <b>นายธนวัฒน์ เสริฐสุวรรณกุล</b><br>งานเทคโนโลยีวิทยทรัพยากรดิจิทัล
    </footer>
   ...
   <script>
    (function () {
      var VERSION_URL = './js/version_main.json';
      var SCRIPT_URL  = './js/main.js';
      var STORAGE_KEY = 'mainJsVersion';
      ...
      function fallbackLoad() {
        ...
        // ยังโหลด main.js ให้ได้ตามปกติ โดยแปะ timestamp กันไว้เป็นเซฟตี้เน็ต
      ...
      async function boot() {
        try {
          ...
          var data = await res.json();          // คาดหวังรูปแบบ { "version": "2026-09-25-01" }
          var latestVersion = String(data.version || Date.now());
          var storedVersion = localStorage.getItem(STORAGE_KEY);


          console.log('%c📄 Version ใน version_main.json (บนเซิร์ฟเวอร์):', 'color:#2196F3;', latestVersion);
...
<<<<<<< HEAD
>>>>>>> b526410014d7415a9844022493031e415f988d72
        <div id="pdpaModal" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,0.6); z-index:9999; padding:10px; box-sizing:border-box;">
            <div style="max-width:600px; max-height:90vh; margin:5vh auto; background:#fff; padding:20px; border-radius:8px; display:flex; flex-direction:column; box-sizing:border-box;">

                <!-- ส่วนหัวและโลโก้ -->
                <div style="flex-shrink:0; text-align:center;">
<<<<<<< HEAD
                    <img src="./PDF/lib_icon.png" loading="lazy" style="max-width:100%; width:300px; height:auto; display:block; margin:0 auto 10px auto;">
=======
                    <img src="./PDF/lib_icon.png" style="max-width:100%; width:300px; height:auto; display:block; margin:0 auto 10px auto;">
>>>>>>> b526410014d7415a9844022493031e415f988d72
                    <h4 style="margin-top:10px; font-size:16px; text-align:left;">
                        หนังสือขอความยินยอมให้ สำนักหอสมุดกลางมหาวิทยาลัยศรีนครินทรวิโรฒ เก็บรวบรวมและใช้ข้อมูลใบหน้า
                        (Facial Scans) ของท่านเพื่อประโยชน์ในการยืนยันตัวตนของท่านสำหรับบันทึกการเข้า-ออกพื้นที่ต่าง ๆ
                    </h4>
                </div>

                <!-- ส่วนเนื้อหาข้อตกลง (เลื่อน Scroll ได้ในพื้นที่นี้) -->
                <div style="flex-grow:1; overflow-y:auto; font-size:14px; margin-bottom:15px; padding-right:5px;">
<<<<<<< HEAD
=======
=======
...
<<<<<<< HEAD
                ...
                <!-- ส่วนปุ่มกด ยินยอม / ไม่ยินยอม -->
                <div style="flex-shrink:0; text-align:right; border-top:1px solid #eee; padding-top:15px;">
                    <button id="pdpaDeclineBtn" class="btn btn-secondary">ไม่ยินยอม</button>
                    <button id="pdpaAcceptBtn" class="btn btn-primary">ยินยอม</button>
                </div>
