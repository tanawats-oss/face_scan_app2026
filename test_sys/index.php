...
<head>
  ...
  <title>Face Capture & Update Template (Fixed)</title>
...
">
  ...
  ">
    ...
    <div class="panel" style="text-align:center;">
      <form action="logout.php" method="post">
        <button type="submit" class="danger" style="font: size 30px;">ออกจากระบบ</button>
      </form>
    </div>
  </div>
  ...
  <script>
    window.oldFaceTemplate = <?= json_encode(
                                !empty($faceResp['template'])
                                  ? [
                                    'TemplateSize' => $faceResp['size'] ?? 0,
                                    'TemplateData' => $faceResp['template']
                                  ]
                                  : null
                              ) ?>;
  </script>
