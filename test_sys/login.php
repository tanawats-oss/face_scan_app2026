...
<body>
    ...
    <script>
        (function() {
            ...
            const domainPath = "lib.swu.ac.th/app/face_scan/test_sys/login.php";
...
<body>
  ...
  `;
    ...
    <div class="login-card">
        <h2>ทดสอบ <br>ระบบลงทะเบียนสแกนใบหน้า</h2>
        <form method="post" action="auth.php" onsubmit="return showLoading()">
            <div class="form-group">
                <label for="user_login">รหัสบัวศรี (Buasri ID)</label>
                <input type="text" id="user_login" name="user_login" required placeholder="รหัสบัวศรี (Buasri ID)"  style="text-transform: lowercase;">
            </div>
            <div class="form-group">
