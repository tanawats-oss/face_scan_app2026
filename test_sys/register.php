    ...
    <form id="editUserForm" action="" method="post">
      ...
      <div class="row ">
        <div class="col-md-6 mb-3">
          <label>ID</label>
          <input class="form-control" value="<?= htmlspecialchars($userId) ?>" readonly>
        </div>
        <div class="col-md-6 mb-3">
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input class="form-control" value="<?= htmlspecialchars($departMent) ?>" readonly>
        </div>
        <div class="col-md-6 mb-3">
          ...
          <select class="form-control">
            ...
            <option value="3000" <?= $userType == 'student' ? 'selected' : '' ?>>นิสิต</option>
            <option value="1000" <?= $userType == 'staff' ? 'selected' : '' ?>>บุคลากร</option>
            <option value="ทดสอบระบบ" <?= $userType == 'testlib007' || $userType == 'testlib008' ? 'selected' : '' ?>>ทดสอบระบบ</option>
          </select>
        </div>
        ...
        <div class="row">
          <div class="col-md-4 mb-3">
            ...
            <input class="form-control" value="<?= (string) date('Y-m-d H:i:s') ?>" readonly>
          </div>
          <div class="col-md-4 mb-3">
        ...
        <p><b>Card Number:</b> <input class="form-control" value="<?= htmlspecialchars($userId) ?>"></p>
        <br>
        <!-- ================== AUTH INFO ================== -->
